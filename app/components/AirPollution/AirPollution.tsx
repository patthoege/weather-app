...
function AirPollution() {
    ...
    return (
    <div 
        className="air-polution col-span-full sm-2:col-span-2 pt-6 px-4 h-[12rem] 
        border border-gray-400 rounded-lg flex flex-col gap-8 dark:bg-dark-grey shadow-sm dark:shadow-none"
    > 
